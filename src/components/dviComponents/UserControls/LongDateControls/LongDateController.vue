    ...
    <v-card flat color="#385F73" dark>
      <div>
        <v-card-title class="subtitle-1 green--text text--lighten-3"
          ...
          ></v-card-title
        >
        <div class="d-flex flex-nowrap justify-start subtitle-2 blue--text text--lighten-3 mb-4 ml-3">Spreads To One Year</div>
        <div v-for="spread in spreads" :key="spread.Term" class="d-flex flex-nowrap justify-start textFieldsLong">    
              <v-text-field
                dense
